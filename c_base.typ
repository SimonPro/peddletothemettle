...
When the test you attempt is related to the definition of that reliable test, it applies. 
When you attempt a test, you can reroll until each die is at least equal to a minimum number. ex reroll 1 and 2. 
